                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12 border border-2 border-secondary rounded p-2 mb-4">
                            <button class="btn btn-sm btn-success btn_agregarComprobantes"><i class="feather-file-plus"></i> &nbsp Agregar</button>
                            <button class="btn btn-sm btn-danger"><i class="fa-solid fa-file-contract"></i> &nbsp Reporte</button>
                        </div>
                        <table id="lista_comprobantes" class="table table-hover table-striped table-bordered w-100">
                            <thead>
                                <tr>
...
getModal('modal_comprobantes',$data);
?>